...
data class PaintItem(
    ...
    companion object {
        ...
        private val NOT_AVAILABLE: Int = R.string.paint_list_item_not_available //"NOT AVAILABLE"
        private val MAYBE: Int = R.string.paint_list_item_mabye
        private val ON_STOCK: Int = R.string.paint_list_item_on_stock
